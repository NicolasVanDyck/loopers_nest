...
@php
    $classes = ($active ?? false)
                ? 'inline-flex items-center px-1 pt-1 border-b-2 border-red-600 text-md font-body leading-5 text-white focus:outline-none focus:border-indigo-700 transition'
